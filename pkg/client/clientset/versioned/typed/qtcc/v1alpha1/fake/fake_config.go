...
var configsResource = schema.GroupVersionResource{Group: "qtcc", Version: "v1alpha1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "qtcc", Version: "v1alpha1", Kind: "Config"}
